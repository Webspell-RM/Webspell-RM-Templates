...
global $userID,$_database,$add_database_install,$str,$str2,$modulname,$add_plugin_manager,$add_navigation,$navi_link,$add_dashboard_navigation,$dashnavi_link,$add_module_install,$add_button_install,$add_theme_install,$add_widget_install,$themes_modulname,$version;
##### @info: Template #################################################################################################################
...
('', '$name', '$modulname', '$pfad', '$version', $active, 0, 'rgb(33,37,41)', '18px', 'rgb(185,143,125)', 'rgb(157,122,106)', 'rgb(185,143,125)', '5px', 'rgb(185,143,125)', 'rgb(157,122,106)', '', 'rgb(37,29,26)', 'rgb(245,245,245)', 'rgb(37,29,26)', 'ms-auto', 'Roboto', '13px', 'rgb(0,0,0)', 'rgb(255,255,255)', 'rgb(58,46,41)', '', '0px', '', '', '', 'rgb(185,143,125)', '', '', '', 'rgb(157,122,106)', 'rgb(0,0,0)', 'rgb(185,143,125)', 'rgb(58,40,32)', '', '', '', '', '', '', '', 'rgb(255,255,255)', 'rgb(185,143,125)', 'rgb(255,255,255)', 'rgb(185,143,125)', 'logo.png', '', '', 'login_bg.jpg', 'rgb(185,143,125)', 'rgb(255,255,255)', 'headlines_01.css', 1);");
